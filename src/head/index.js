...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const data = {
        "menus": [
            {
                "title": "File",
                "items": [
                    { "label": "New page", "icon": images.new, "shortcut": "Ctrl+N", "action": "newFile", "description": "Create a new file" },
                    { "label": "Open page", "icon": images.open, "shortcut": "Ctrl+O", "action": "openFile", "description": "Open an existing file" },
                    { "label": "separator" },
                   ...
                   /* { "label": "Open symbol File", "icon": images.symbol, "shortcut": "Ctrl+N+S", "action": "openSymbol", "description": "Open symbol file" },*/
                    { "label": "New symbol", "icon": images.newSymbol, "shortcut": "Ctrl+N+S", "action": "newSymbol", "description": "Create a new symbol file" },
                    { "label": "Open symbol", "icon": images.openSymbol, "shortcut": "Ctrl+O+S", "action": "openSymbol", "description": "Open an existing symbol file" },
                  /*  { "label": "separator" },
                    { 
            ...
            
            {
                ...
                "items": [
                    ...
                    { "label": "Port", "icon": images.port, "shortcut": " ", "action": "port", "description": "Add port" },
                    { "label": "VBar", "icon": images.vbar, "shortcut": " ", "action": "vbar", "description": "Add voltage bar" },
                    ...
                    { "label": "Spice model", "icon": images.model, "shortcut": " ", "action": "modelSpice", "description": "Add spice model name" },
                ...
                "items": [
                    ...
                    { "label": "Library manager", "icon": images.library, "shortcut": " ", "action": "openLibraryManager", "description": "Open library manager" },
                ...
                "items": [
                    ...
                    { "label": "separator" },
                    { "label": "Run Op", "icon": images.runOP, "shortcut": " ", "action": "runOpAnalysis", "description": "Run Op" }/*,
        ...
        "toolbar": [
            ...
            { "label": "separatorbar" },
            { "label": "New symbol File", "icon": images.newSymbol,  "action": "newSymbol", "description": "Create a new symbol file" },
            { "label": "New symbol File", "icon": images.openSymbol,  "action": "openSymbol", "description": "Open an existing symbol file" },
            { "label": "separatorbar" },
            ...
            { "label": "Port", "icon": images.port,  "action": "port", "description": "Add port" },
            { "label": "VBar", "icon": images.vbar,  "action": "vbar", "description": "Add voltage bar" },
            ...
            { "label": "Model", "icon": images.model, "action": "modelSpice", "description": "Add spice model name" },
...
function showMenu(menu, event) {
    console.log("showMenu", menu.id, event.pageX, event.pageY);
    
    if (files.length === 0) {
        console.log("No files open, not showing menu");
        return; // Do not show the menu if no files are open
    }
