...
*/
  ...
  const fileTypes = {
            dcs: { icon: '<img src="images/file-cds.svg" width="20" height="20" />', label: 'Designing Circuits and Simulation File', ext: '.dcs', lang: 'Designing' },
            sym: { icon: '<img src="images/file-sym.svg" width="20" height="20"  />', label: 'Symbol File', ext: '.sym', lang: 'Symbol' }
...
//=====Welom Page===========================//
        ...
        function welcomPage(){
          document.title='Designing and Simulating Circuits with SPICE  [Welcome]';
          document.querySelectorAll('.space-work').forEach(el => {
        ...
        <div class="welcome-page" id="welcomePage">
           <div class="welcome-content">
             <h1 class="welcome-title"><span class="icon"><img src="form/logo.png" class="welcome-icon" width="100" height="100" ></span>DSpice 0.0.9</h1>
            ...
            <div class="welcome-columns">
              <div class="welcome-column">
                <h3>Start</h3>
                  ...
                  <h3><span class="icon"></span>Circuit Design and Simulation...</h3>
                      <ul class="start-list">
                       <li><a href="#" onclick="addNewTab('dcs')"><img src="images/file.svg" width="20" height="20" />New Page...</a></li>
                       <li><a href="#" onclick="openFile('dcs')"><img src="images/open.svg" width="20" height="20" />Open Page...</a></li>
                       
                      </ul>


                   <h3>Schematic Symbols and SPICE Models....</h3>
                       <ul class="start-list">
                         <li><a href="#" onclick="addNewTab('sym')"><img src="images/new-sym.svg" width="20" height="20" />New Symbol...</a></li>
                         <li><a href="#" onclick="openFile('sym')"><img src="images/open-sym.svg" width="20" height="20" />Open Symbol...</a></li>
                       </ul>
              ...
              <div class="welcome-column">
                ...
                <div class="walkthrough-list">
                  <div class="walkthrough-item">
                    ...
                    <div class="walkthrough-info">
                      ...
                      <div class="walkthrough-desc">
                         The primary objective of <b>DSpice</b> (Designing Circuits and Simulation by SPICE) is to facilitate the modeling of analog elements 
                         and the simulation of electronic circuits. By utilizing the <b>ngspice</b> engine, the tool enables efficient circuit design 
                         and simulation through structured libraries, packages, and command sets. DSpice is distributed as free software under GNU terms. 
                         The platform currently facilitates detailed Operating Point (OP), DC, and Time-Domain analyses, 
                         with Frequency-Domain analysis slated for future development. 
                         Output signals are acquired at distinct operating points and rendered via a dedicated waveform visualization interface..
                      </div>
                    </div>
                  </div>
                  <div class="walkthrough-item">
                    ...
                    <div class="walkthrough-info">
                      ...
                      <div class="walkthrough-desc">
                          <p>DSpice offers comprehensive circuit design and simulation capabilities, featuring an intuitive schematic editor for drawing circuits with ease.
                          ...
                          Additionally, developers can build new DSpice models for 
                          electrical components using the library, offering extensive flexibility in designing and adapting complex systems according to project requirements.
                          </p>
                      </div>
                      </div>
                     </div>
                  ...
                  <div class="walkthrough-item">
                    ...
                    <div class="walkthrough-desc">
                        DSpice uses ngspice as its core simulation engine to separate the user interface from the heavy computational math. ngspice is a mature, 
                        industry-standard open-source SPICE solver that handles the complex calculations required for circuit simulation.
                        By leveraging ngspice as the backend, DSpice can focus entirely on the frontend: providing a streamlined workflow, managing design libraries, and visualizing waveforms. 
                        This integration ensures that DSpice delivers highly accurate operating-point, DC, and transient analyses without reinventing the mathematical solvers from scratch.
                        Additionally, both tools share a strong open-source philosophy, ensuring the entire design environment remains free and accessible.                   
                    </div>
                    </div>
                  </div>
                  <!--div class="walkthrough-item">
